...
class _PlayerMatchDetailViewState extends State<_PlayerMatchDetailView> with SingleTickerProviderStateMixin {
  ...
  final Map<String, List<Map<String, dynamic>>> _teamLineups = {
    'CORE FC': [
      {'name': 'E. Martinez', 'no': '1'},
      {'name': 'T. Hernandez', 'no': '3'},
      {'name': 'V. van Dijk', 'no': '4'},
      {'name': 'Ruben Dias', 'no': '5'},
      {'name': 'K. Walker', 'no': '2'},
      {'name': 'K. De Bruyne', 'no': '17'},
      {'name': 'Rodri', 'no': '16'},
      {'name': 'J. Bellingham', 'no': '10'},
      {'name': 'M. Salah', 'no': '11'},
      {'name': 'K. Mbappe', 'no': '7'},
      {'name': 'L. Messi', 'no': '10'},
    ],
    'DUBAI CITY FC': [
      {'name': 'Ederson', 'no': '31'},
      {'name': 'Marquinhos', 'no': '5'},
      {'name': 'Ruben Dias', 'no': '3'},
      {'name': 'A. Hakimi', 'no': '2'},
      {'name': 'Joao Cancelo', 'no': '7'},
      {'name': 'D. Rice', 'no': '41'},
      {'name': 'Phil Foden', 'no': '47'},
      {'name': 'B. Silva', 'no': '20'},
      {'name': 'Vini Jr.', 'no': '7'},
      {'name': 'B. Saka', 'no': '7'},
      {'name': 'E. Haaland', 'no': '9'},
