          ...
          child: Row(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text('MARK ATTEND', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        ),
        const SizedBox(height: 25),
        _buildAttendanceItem('Training Session', '02 JUL', 'ATTEND', Colors.greenAccent),
        _buildAttendanceItem('Match v East Bengal', '30 JUN', 'ATTEND', Colors.greenAccent),
        _buildAttendanceItem('Tactical Meeting', '28 JUN', 'ABSENT', Colors.redAccent),
        _buildAttendanceItem('Recovery Session', '25 JUN', 'ATTEND', Colors.greenAccent),
      ],
    );
  }
